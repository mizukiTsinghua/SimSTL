...
namespace SimSTL
{
	...
	private:
		...
		typedef SimSTL::allocator<node> nodeAllocator;
	public:
		typedef T value_type;
		typedef Library::bst_iter<node> const_iterator;
	...
	namespace Library
	{
		...
		class bst_iter :
			public iterator<forward_iterator_tag, typename ::SimSTL::binary_search_tree<typename T::value_type>::value_type>{
		private:
			template<class T>
			friend class ::SimSTL::binary_search_tree;
		private:
			//typedef typename ::SimSTL::binary_search_tree<typename T::value_type>::value_type value_type;
			typedef typename ::SimSTL::binary_search_tree<typename T::value_type>::const_reference const_reference;
			typedef typename const T::value_type *const_pointer;
			typedef const ::SimSTL::binary_search_tree<typename T::value_type> * cntrPtr;
		private:
			const T *ptr_;
			cntrPtr container_;
