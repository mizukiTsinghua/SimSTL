...
namespace SimSTL{
	...
	namespace Container {
		...
		private:
			...
			friend class ::SimSTL::deque;
		private:
			//typedef SimSTL::deque<T>* cntrPtr;
			typedef const ::SimSTL::deque<T>* cntrPtr;
			size_t mapIndex_;
			T *cur_;
			cntrPtr container_;
		public:
	...
	private:
		template<class T>
		friend class ::SimSTL::Container::dq_iter;
	public:
		typedef T value_type;
		typedef Container::dq_iter<T> iterator;
		typedef Container::dq_iter<const T> const_iterator;
		typedef T& reference;
