...
namespace SimSTL
{
	...
	private:
		typedef allocator<Container::node<T>> nodeAllocator;
		typedef Container::node<T> *nodePtr;
	public:
		typedef T value_type;
		typedef Container::listIterator<T> iterator;
		typedef Container::listIterator<const T> const_iterator;
