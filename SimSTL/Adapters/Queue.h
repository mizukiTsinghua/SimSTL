...
#include "Library/Functional.h"
#include "Container/Vector.h"

namespace SimSTL
{
	// queue
	template<class T, class Container = SimSTL::deque<T>>
	class queue
	{
	public:
	...
	{
		SimSTL::swap(x.container_, y.container_);
	}

	// priority_queue
	template <class T, class Container = SimSTL::vector<T>,
		class Compare = SimSTL::less<typename Container::value_type>>
	...
	public:
		...
		priority_queue(InputIterator first, InputIterator last,
			...
			SimSTL::make_heap(container_.begin(), container_.end());
		}
		...
		void push(const value_type& val)
		{
			...
			SimSTL::push_heap(container_.begin(), container_.end(), compare_);
		}

		void pop()
		{
			SimSTL::pop_heap(container_.begin(), container_.end(), compare_);
			container_.pop_back();
		}

		void swap(priority_queue& x)
		{
			SimSTL::swap(container_, x.container_);
			SimSTL::swap(compare_, x.compare_);
		}
